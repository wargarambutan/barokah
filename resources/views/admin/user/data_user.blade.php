        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    <a href="{{ route('user-barokah.create') }}" class="btn btn-primary btn-round btn-sm ms-auto">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('user-barokah.show', $data->id) }}" title="Detail">
                                                        <i class="fa fa-eye"></i> Detail
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('user-barokah.edit', $data->id) }}" title="Edit">
                                                        <i class="fa fa-edit"></i> Edit
                                                    </a>
                                                </li>
                                                <li>
                                                    <form id="delete-form"
                                                        action="{{ route('user-barokah.destroy', $data->id) }}"
