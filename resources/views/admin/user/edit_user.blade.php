                ...
                <form action="{{ route('karyawan-barokah.update', $karyawan->id ?: 'Data Belum Diisi') }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nama_lengkap') is-invalid @enderror"
                            ...
                            value="{{ old('nama_lengkap', $karyawan->nama_lengkap ?: 'Data Belum Diisi') }}" required>
                        @error('nama_lengkap')
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                            name="email" value="{{ old('email', $karyawan->email ?: 'Data Belum Diisi') }}" required>
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('jabatan') is-invalid @enderror" id="jabatan"
                            name="jabatan" value="{{ old('jabatan', $karyawan->jabatan ?: 'Data Belum Diisi') }}" required>
                        @error('jabatan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
