 ?: 'Data Tidak Diisi'@extends('layouts.admin')
 @section('title', 'Laporan Pendaftar')
 @section('content')
     <div class="d-xl-flex justify-content-between align-items-start mb-3">
         <h2 class="text-dark font-weight-bold mb-2">Detail Karyawan Diterima</h2>
         <a href="{{ route('diterima') }}" class="btn btn-secondary btn-round">Kembali</a>
     </div>
