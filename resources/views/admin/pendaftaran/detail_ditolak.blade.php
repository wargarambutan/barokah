...
@section('content')
    <div class="d-xl-flex justify-content-between align-items-start mb-3">
        <h2 class="text-dark font-weight-bold mb-2">Detail Karyawan Ditolak</h2>
        <a href="{{ route('ditolak') }}" class="btn btn-secondary btn-round">Kembali</a>
    </div>
                ...
                <form>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" id="nama_institusi"
                                        value="{{ $karyawan->nama_institusi }}" readonly>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <label for="tahun_lulus" class="form-label">Tahun Lulus</label>
                                    <input type="text" class="form-control" id="tahun_lulus"
                                        value="{{ $karyawan->tahun_lulus }}" readonly>
                                </div>
                            </div>
                    ...
                    <div class="col-12 text-end">
                        ...
                        <ul class="dropdown-menu" id="statusDropdown">
                            <li><a class="dropdown-item" href="#" data-status="Menunggu Verifikasi">Menunggu
                                    Verifikasi</a></li>
                            <li><a class="dropdown-item" href="#" data-status="Diterima">Diterima</a></li>
                            <li><a class="dropdown-item" href="#" data-status="Ditolak">Ditolak</a></li>
                        </ul>
                    </div>
                </div> --}}
