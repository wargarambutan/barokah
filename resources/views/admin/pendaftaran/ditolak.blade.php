...
@section('content')
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            <h3 class="fw-bold mb-3">Karyawan Ditolak</h3>
        </div>
    </div>
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    <table id="add-row" class="display table table-striped table-hover">
                        ...
                        <tbody>
                            @forelse ($karyawanDitolak as $index => $karyawan)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('karyawan.ditolak', $karyawan->id) }}"
                                            class="btn btn-link btn-success btn-sm" data-bs-toggle="tooltip"
                                            title="Lihat Detail">
                                            <i class="fa fa-eye fa-2x"></i>
                                        </a>
                                        <a href="{{ route('admin.kirimEmailDitolakForm', $karyawan->id) }}"
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center">Tidak ada data karyawan yang ditolak</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
...
@section('script')
    @if ($karyawanDitolak->isNotEmpty())
        <script>
            ...
            @foreach ($karyawanDitolak as $karyawan)
