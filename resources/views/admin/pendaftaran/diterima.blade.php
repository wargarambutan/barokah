...
@section('title', 'Karyawan Ditolak')
@section('content')
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            <h3 class="fw-bold mb-3">Karyawan Diterima</h3>
        </div>
    </div>
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    <table id="add-row" class="display table table-striped table-hover">
                        ...
                        <tbody>
                            @forelse ($karyawanDiterima as $index => $karyawan)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                                        ...
                                                        <div
                                                            ...
                                                            @if (pathinfo($karyawan->foto_ktp, PATHINFO_EXTENSION) === 'pdf')
                                                                <embed src="{{ asset('storage/' . $karyawan->foto_ktp) }}"
                                                                    type="application/pdf" width="40%" height="700px" />
                                                            @else
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('karyawan.diterima', $karyawan->id) }}"
                                            class="btn btn-link btn-success btn-sm" data-bs-toggle="tooltip"
                                            title="Lihat Detail">
                                            <i class="fa fa-eye fa-2x"></i>
                                        </a>
                                        <a href="{{ route('karyawan.kirimEmailDiterimaForm', $karyawan->id) }}"
                                            class="btn btn-link btn-primary btn-sm" data-bs-toggle="tooltip"
                                            title="Kirim Email">
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center">Tidak ada data karyawan yang diterima</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
...
@section('script')
    @if ($karyawanDiterima->isNotEmpty())
        <script>
            ...
            @foreach ($karyawanDiterima as $karyawan)
