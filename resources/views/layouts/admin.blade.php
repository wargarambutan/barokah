            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    <ul class="nav nav-secondary">
                        ...
                        <li
                            class="nav-item {{ Request::is('verifikasi') || Request::is('diterima') || Request::is('ditolak') || Request::is('laporan') ? 'active' : '' }}">
                            <a data-bs-toggle="collapse" href="#rekrutmen"
                                class="{{ Request::is('verifikasi') || Request::is('diterima') || Request::is('ditolak') || Request::is('laporan') ? 'show' : '' }}">
                                <i class="fas fa-user-plus"></i>
                                <p>Rekrutmen</p>
                                <span class="caret"></span>
                            </a>
                            <div class="collapse {{ Request::is('verifikasi') || Request::is('diterima') || Request::is('ditolak') || Request::is('laporan') ? 'show' : '' }}"
                                id="rekrutmen">
                                <ul class="nav nav-collapse">
                                    ...
                                    <li class="{{ Request::is('diterima') ? 'active' : '' }}">
                                        <a href="{{ route('diterima') }}">
                                            <span class="sub-item">Diterima</span>
                                        </a>
                                    </li>
                                    <li class="{{ Request::is('ditolak') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::routeIs('karyawan-barokah.index') ? 'active' : '' }}">
                            <a href="{{ route('karyawan-barokah.index') }}">
                        ...
                        <li class="nav-section">
                            ...
                            <h4 class="text-section">Konfigurasi Pendaftaran</h4>
                        </li>
                        <li class="nav-item d-flex justify-content-center align-items-center">
                            <!-- Tombol untuk mengubah status pendaftaran -->
                            <form action="{{ route('ubah-status-pendaftaran') }}" method="POST" id="statusForm">
                                @csrf
                                <button type="submit" class="btn btn-primary btn-sm button-geser">
                                    {{ $statusPendaftaran === 'Buka' ? 'Tutup' : 'Buka' }}
                                </button>
                            </form>
                        </li>
