...
!(function (t, e) {
    ...
    class X extends M {
        ...
        _addEventListeners() {
            this._config.keyboard &&
                ...
                "hover" === this._config.pause &&
                    (I.on(this._element, "mouseenter.bs.carousel", (t) =>
                        this.pause(t)
                    ),
                    I.on(this._element, "mouseleave.bs.carousel", (t) =>
                        this.cycle(t)
                    )),
                this._config.touch &&
                    this._touchSupported &&
        ...
        _slide(t, e) {
            ...
            if (r && r.classList.contains("active")) this._isSliding = !1;
                ...
                !this._triggerSlideEvent(r, p).defaultPrevented &&
                n &&
                r
            ) {
                if (
    ...
    function Et(t) {
        for (
            var e = lt(t), i = wt(t);
            i && bt(i) && "static" === _t(i).position;

        )
            i = wt(i);
        return i &&
            ("html" === at(i) ||
                ("body" === at(i) && "static" === _t(i).position))
            ? e
            : i ||
                  (function (t) {
                      var e =
    ...
    function Nt(t) {
        ...
        if (l) {
            ...
            y === lt(i) &&
                ...
                (y = y),
                s === J &&
                    ((b = tt), (p -= y[w] - n.height), (p *= a ? 1 : -1)),
                s === it &&
                    ((_ = et), (u -= y[E] - n.width), (u *= a ? 1 : -1));
        }
        var T,
                  ...
                  (function (t) {
                      ...
                      return (
                          "rtl" === _t(s || i).direction &&
                              (a +=
                                  At(i.clientWidth, s ? s.clientWidth : 0) - o),
    ...
    class ye extends M {
        ...
        show() {
            ...
            if (
                !I.trigger(this._element, "show.bs.dropdown", e)
                    .defaultPrevented
            ) {
                if (this._inNavbar)
    ...
    const Me = new Set([
        ...
        Be = (t, e) => {
            ...
            if (e.includes(i))
                return (
                    !Me.has(i) ||
                    Boolean(He.test(t.nodeValue) || Re.test(t.nodeValue))
                );
        ...
        _setListeners() {
            this.config.trigger.split(" ").forEach((t) => {
                if ("click" === t)
                    ...
                    I.on(this._element, e, this.config.selector, (t) =>
                        this._enter(t)
                    ),
                        I.on(this._element, i, this.config.selector, (t) =>
                            this._leave(t)
                        );
                }
            }),
