    ...
    function a(b, c) {
        ...
        (this.nativeDraggable = !c.forceFallback && ca),
            ...
            this.nativeDraggable &&
                (f(b, "dragover", this), f(b, "dragenter", this)),
    ...
    var y,
        ...
        ja = s(function (a, b, c) {
            if (c && b.scroll) {
                ...
                if (
                    G !== c &&
                    ((F = b.scroll), (G = c), (H = b.scrollFn), F === !0)
                ) {
                    F = c;
                    do
                        if (
            ...
            _emulateDragOver: function () {
                if (Q) {
                    ...
                    if (
                        (a &&
                            a.shadowRoot &&
                            ((a = a.shadowRoot.elementFromPoint(
                                Q.clientX,
                                Q.clientY
                            )),
                            (b = a)),
                ...
                if (P) {
                    ...
                    if (!a.active) {
                        if (
                            d &&
                            ga(
                                fa(f.clientX - this._lastX),
                                fa(f.clientY - this._lastY)
                            ) < d
                        )
                            return;
                        this._dragStarted();
            ...
            _appendGhost: function () {
                if (!A) {
                    ...
                    (A = y.cloneNode(!0)),
                        ...
                        (d.fallbackOnBody && X.body.appendChild(A)) ||
                            C.appendChild(A),
