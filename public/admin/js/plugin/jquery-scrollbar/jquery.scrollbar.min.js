            ...
            t.scroll ||
                ...
                l(window).resize(function () {
                    ...
                    if (t.scroll && (t.scroll.height || t.scroll.width)) {
                        var o = e();
                        (o.height !== t.scroll.height ||
                            o.width !== t.scroll.width) &&
                            ((t.scroll = o), (l = !0));
                    }
                    a(l);
                })),
    ...
    n.prototype = {
        ...
        init: function (e) {
                    ...
                    r.on("scroll" + n, function (e) {
                        l.isFunction(c.onScroll) &&
                            ...
                            a.x.isVisible &&
                                a.x.scroll.bar.css(
                                    "left",
                                    r.scrollLeft() * a.x.kx + "px"
                                ),
                            a.y.isVisible &&
                                a.y.scroll.bar.css(
                                    "top",
                                    r.scrollTop() * a.y.kx + "px"
                                );
                    }),
            ...
            l.each(a, function (e, t) {
                ...
                t.scroll ||
                    ((t.scroll = o
                        ._getScroll(c["scroll" + e])
                        .addClass("scroll-" + e)),
                    c.showArrows &&
                        t.scroll.addClass("scroll-element_arrows_visible"),
                    (t.mousewheel = function (l) {
                        if (!t.isVisible || ("x" === e && s(l))) return !0;
                        if ("y" === e && !s(l)) return a.x.mousewheel(l), !0;
                        var i =
                                -1 * l.originalEvent.wheelDelta ||
                                l.originalEvent.detail,
                        ...
                        .on("mousedown" + n, function (s) {
                            ...
                            return (
                                l(this).hasClass("scroll-arrow")
                                    ...
                                    : ((d =
                                          n.eventOffset >
                                          n.scrollbarOffset + n.scrollbarSize
                                              ? 1
                                              : n.eventOffset <
                                                n.scrollbarOffset
                                              ? -1
                                ...
                                setTimeout(function () {
                                    o.scrollTo &&
                                        (r.animate(o.scrollTo, c.duration),
                                        (o.scrollTo = null));
                                }, 1),
                ...
                l.each(a, function (l, e) {
                    var o = "x" === l ? "left" : "top",
                        ...
                        d =
                            e.scroll.size[s]() +
                            (parseInt(e.scroll.size.css(o), 10) || 0);
                    c.autoScrollSize &&
        ...
        _updateScroll: function (e, o) {
            var s = this.container,
                ...
                c =
                    parseInt(
                        this.container.css("x" === e ? "left" : "top"),
                        10
                    ) || 0,
                a = this.wrapper,
                d = o.size,
