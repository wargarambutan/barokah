...
!(function (e, t) {
    ...
    return (
        ...
        (c.prototype.addControl = function (e) {
            ...
            return (
                this.controls.push(t), this.map.controls[t.position].push(t), t
            );
        }),
                ...
                for (o = 0; o < e.length; o++) {
                    ...
                    if (n > -1)
                        (i = this.markers[n]).setMap(null),
                            this.markerClusterer &&
                                this.markerClusterer.removeMarker(i),
                            c.fire("marker_removed", i, this);
                }
        ...
        (c.prototype.addLayer = function (e, t) {
            ...
            switch (((t = t || {}), e)) {
                case "weather":
                    ...
                    break;
                case "clouds":
                    this.singleLayers.clouds = o =
                        new google.maps.weather.CloudLayer();
                    break;
                case "traffic":
                    this.singleLayers.traffic = o =
                        new google.maps.TrafficLayer();
                    break;
                case "transit":
                    this.singleLayers.transit = o =
                        new google.maps.TransitLayer();
                    break;
                case "bicycling":
                    this.singleLayers.bicycling = o =
        ...
        (c.prototype.getElevations = function (e) {
            (e = r({ locations: [], path: !1, samples: 256 }, e)).locations
                .length > 0 &&
            ...
            (t.panel = n),
                ...
                this.getRoutes({
                    ...
                    callback: function (e, t, n) {
                        n === google.maps.DirectionsStatus.OK &&
                            o.setDirections(t);
                    },
                });
        }),
                ...
                this.getRoutes({
                    ...
                    callback: function (t) {
                        if (
                            ...
                            if (o.legs.length > 0)
                                for (
                                    var n, i = o.legs[0].steps, r = 0;
                                    (n = i[r]);
                                    r++
                                )
                                    (n.step_number = r),
                                        e.step(n, o.legs[0].steps.length - 1);
                        }
                ...
                this.getRoutes({
                    ...
                    callback: function (o) {
                        if (
                            (o.length > 0 &&
                                e.start &&
                                e.start(o[o.length - 1]),
                            o.length > 0 && e.step)
                        ) {
                            var n = o[o.length - 1];
                            if (n.legs.length > 0)
                                for (
                                    var i, r = n.legs[0].steps, s = 0;
                                    (i = r[s]);
                                    s++
                                ) {
                                    i.step_number = s;
        ...
        (c.staticMapURL = function (e) {
            ...
            var i = e.markers;
            delete e.markers,
                !i && e.marker && ((i = [e.marker]), delete e.marker);
            var r = e.styles;
            delete e.styles;
            var s = e.polyline;
                ...
                for (var g, h, d = 0; (t = i[d]); d++) {
                    (g = []),
                        t.size && "normal" !== t.size
                            ...
                            : t.icon &&
                              (g.push("icon:" + encodeURI(t.icon)),
                              delete t.icon),
                        t.color &&
                            (g.push("color:" + t.color.replace("#", "0x")),
                            delete t.color),
                        t.label &&
                            (g.push("label:" + t.label[0].toUpperCase()),
                            delete t.label),
            ...
            if (s) {
                if (
                    ...
                    (s = []),
                    t.strokeWeight &&
                        s.push("weight:" + parseInt(t.strokeWeight, 10)),
                    t.strokeColor)
                ) {
        ...
        "object" == typeof window.google &&
            ...
            google.maps.Polygon.prototype.containsLatLng ||
                (google.maps.Polygon.prototype.containsLatLng = function (e) {
                    ...
                    for (
                        var o = !1, n = this.getPaths().getLength(), i = 0;
                        i < n;
                        i++
                    )
                        for (
        ...
        Array.prototype.indexOf ||
            (Array.prototype.indexOf = function (e) {
                ...
                if (
                    ...
                    return -1;
                for (
                    var i = n >= 0 ? n : Math.max(o - Math.abs(n), 0);
                    i < o;
                    i++
                )
