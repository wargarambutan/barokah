...
var List = (function (t) {
            ...
            return function (t, e, s, a) {
                return (
                    ...
                    (!a.test && document.getElementsByClassName)
                        ? r(t, e, s)
                        : (a.test && a.querySelector) ||
                          (!a.test && document.querySelector)
                        ? n(t, e, s)
                        : i(t, e, s)
                );
            };
            ...
            var e = {
                    ...
                    setOrder: function (r) {
                        for (var n = 0, i = e.els.length; n < i; n++) {
                            var s = e.els[n];
                            if (
                                t.utils.getAttribute(s, "data-sort") ===
                                r.valueName
                            ) {
                ...
                r = function () {
                    ...
                    n
                        ...
                        : ((r = arguments[1] || r),
                          ...
                          (r.order = r.order || "asc"),
                          (r.insensitive =
                              "undefined" == typeof r.insensitive ||
                              r.insensitive)),
                        e.clear(),
                        e.setOrder(r);
                    var i,
        ...
        var r = function (t) {
            ...
            (this.clearSourceItem = function (e, r) {
                ...
                (this.getItemSource = function (e) {
                    if (void 0 === e) {
                        for (
                            var r = t.list.childNodes, n = 0, i = r.length;
                            n < i;
                            n++
                        )
    ...
    function (t, e) {
        t.exports = function (t, e, r) {
            ...
            c = -1;
            for (
                var h, d, v, m = e.length + t.length, g = 0;
                g < e.length;
                g++
            ) {
                for (h = 0, d = m; h < d; )
