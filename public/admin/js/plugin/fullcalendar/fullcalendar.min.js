                ...
                s = (function (t) {
                    ...
                    return (
                        ...
                        (e.prototype.on = function (t, e) {
                            return (
                                r(this).on(t, this._prepareIntercept(e)), this
                            );
                        }),
                        (e.prototype.one = function (t, e) {
                            return (
                                r(this).one(t, this._prepareIntercept(e)), this
                            );
                        }),
                    ...
                    return (
                        (t.createFromRawProps = function (e, n, a) {
                            ...
                            return (
                                ...
                                f.id !== p.id && (y = f.id),
                                i.isArraysEqual(f.className, p.className) ||
                                    (m = f.className),
                ...
                p = (function (t) {
                    function e(e, n) {
                        ...
                        return (
                            ...
                            (i.eventOrderSpecs = s.parseFieldSpecs(
                                i.opt("eventOrder")
                            )),
                    ...
                    return (
                        ...
                        (e.prototype.queryScroll = function () {
                            ...
                            return (
                                this.isDatesRendered &&
                                    r.extend(t, this.queryDateScroll()),
                                t
                            );
                        }),
                ...
                u = (function (t) {
                    ...
                    return (
                        ...
                        (e.prototype.fetch = function (t, e, n) {
                            ...
                            return (
                                (this.currentTimezone = n), s.default.resolve(r)
                            );
                        }),
                    ...
                    return (
                        ...
                        (t.prototype.queryBoundingRect = function () {
                            ...
                            return this.els.length > 0 &&
                                ((t = r.getScrollParent(this.els.eq(0))),
                                !t.is(document))
                                ? r.getClientRect(t)
                                : null;
                        }),
                ...
                a = (function () {
                    ...
                    return (
                        ...
                        (t.prototype.computeScrollBounds = function () {
                            this.isAutoScroll &&
                                (this.scrollBounds = r.getOuterRect(
                                    this.scrollEl
                                ));
                        }),
                    ...
                    return (
                        ...
                        (e.prototype.updateDayTable = function () {
                            for (
                                var t,
                                    ...
                                    o = r.calendar,
                                    s = o.msToUtcMoment(
                                        i.dateProfile.renderUnzonedRange
                                            .startMs,
                                        !0
                                    ),
                                    a = o.msToUtcMoment(
                        ...
                        (e.prototype.renderBgCellHtml = function (t, e) {
                            ...
                            return (
                                o.unshift(
                                    "fc-day",
                                    i.calendar.theme.getClass("widgetContent")
                                ),
                                '<td class="' +
                                    o.join(" ") +
                                    '"' +
                    ...
                    return (
                        ...
                        (e.prototype.resliceDaySegs = function (t, e) {
                            ...
                            for (n = 0; n < t.length; n++)
                                (i = t[n]),
                                    (o =
                                        i.footprint.componentFootprint.unzonedRange.intersect(
                                            c
                                        )) &&
                                        p.push(
                                            r.extend({}, i, {
                            ...
                            if (d)
                                for (e = 0; e < i.length; e++)
                                    if (
                                        !1 ===
                                        d(
                                            i[e].componentFootprint.toLegacy(
                                                this._calendar
                                            ),
                                            i[e].getEventLegacy()
                                        )
                    ...
                    return (
                        ...
                        (e.prototype.clone = function () {
                            ...
                            return (
                                ...
                                this.dowHash &&
                                    (e.dowHash = r.extend({}, this.dowHash)),
                                e
                            );
                        }),
                        e
                    ...
                    return (
                        ...
                        (t.prototype.buildEventDefs = function (t) {
                            ...
                            for (
                                ...
                                (o && !r[e].dow) ||
                                    s.push(this.buildEventDef(t, r[e]));
                            return s;
                        }),
                    ...
                    function e(n, i) {
                        ...
                        return (
                            ...
                            r.eventRendererClass &&
                                (r.eventRenderer = new r.eventRendererClass(
                                    r,
                                    r.fillRenderer
                                )),
                    ...
                    return (
                        ...
                        (t.prototype.updateToolbarButtons = function (t) {
                            var e = this.getNow(),
                                ...
                                r = n.dateProfileGenerator.buildPrev(
                                    n.get("dateProfile")
                                ),
                    ...
                    return (
                        ...
                        (e.prototype.executeEventRender = function (t) {
                            ...
                            this.timeGrid.executeEventRender(r),
                                this.dayGrid &&
                                    this.dayGrid.executeEventRender(i);
                        }),
                        (e.prototype.renderDrag = function (t, e, n) {
                            var r = i(t),
                                o = !1;
                ...
                l = (function (t) {
                    ...
                    return (
                        ...
                        (e.prototype.isDateInOtherMonth = function (t, e) {
                            return (
                                t.month() !==
                                r.utc(e.currentUnzonedRange.startMs).month()
                            );
                        }),
                        e
                    );
                ...
                s = (function () {
                    ...
                    return (
                        ...
                        (t.prototype.documentMousedown = function (t) {
                            this.el &&
                                !i(t.target).closest(this.el).length &&
                                this.hide();
                        }),
                        (t.prototype.removeElement = function () {
                            this.hide(),
                        ...
                        (e.prototype.fgSegHtml = function (t, e) {
                            var n,
                                ...
                                u =
                                    ...
                                    s &&
                                    t.isStart &&
                                    r.isEventDefResizableFromStart(o),
                                d =
                                    !e &&
                                    s &&
                                    t.isEnd &&
