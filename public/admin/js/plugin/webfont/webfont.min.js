...
(function () {
    ...
    function M(a, b) {
        ...
        d =
            ...
            G(b.Q) +
            ";" +
            ("font-style:" + F(b) + ";font-weight:" + (b.M + "00") + ";");
        c.style.cssText = d;
    }
    function N(a) {
        s(a.a, "body", a.m);
    ...
    function ja(a) {
        var b = a.w.m.offsetWidth,
            c = a.A.m.offsetWidth,
            d;
        (d = b === a.s.serif && c === a.s["sans-serif"]) ||
            (d = S() && ka(a, b, c));
        d
            ? p() - a.ga >= a.v
                ? S() &&
                  ka(a, b, c) &&
                  (null === a.Z || a.Z.hasOwnProperty(a.g.getName()))
                    ? T(a, a.G)
                    : T(a, a.J)
                : la(a)
            : T(a, a.G);
    ...
    U.prototype.V = function (a) {
        ...
        b.u &&
            t(
                b.j,
                [b.e.d(b.f, a.getName(), I(a).toString(), "active")],
                [
                    b.e.d(b.f, a.getName(), I(a).toString(), "loading"),
                    b.e.d(b.f, a.getName(), I(a).toString(), "inactive"),
                ]
            );
        J(b, "fontactive", a);
        this.ba = !0;
                    ...
                    for (h = 0; h < c.length; h++) {
                        ...
                        null === V &&
                            (V = window.FontFace
                                ...
                                : !1);
                        q = V
                            ? new O(n(b.V, b), n(b.W, b), b.a, m, b.v, w)
                            : new P(n(b.V, b), n(b.W, b), b.a, m, b.v, a, w);
                        k.push(q);
                    }
    ...
    W.prototype.B = function (a) {
        ...
        return (
            ...
            (b.k.location.hostname || b.F.location.hostname) +
            "/" +
            a +
            ".js"
        );
    ...
    Y.prototype.B = function (a, b) {
        var c = v(this.a),
            d = (this.c.api || "fast.fonts.net/jsapi").replace(
                /^.*http(s?):(\/\/)?/,
                ""
            );
            ...
            if (e["__mti_fntLst" + c]) {
                ...
                if (d)
                    for (var h = 0; h < d.length; h++) {
                        ...
                        void 0 != d[h].fontStyle && void 0 != d[h].fontWeight
                            ? ((l = d[h].fontStyle + d[h].fontWeight),
                              g.push(new E(k, l)))
                            : g.push(new E(k));
                    }
                a(g);
