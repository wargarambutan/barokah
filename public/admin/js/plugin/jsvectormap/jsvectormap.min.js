!(function (t, e) {
    ...
    var d = function (t, e, i) {
        ...
        f = function (t) {
            return "object" == typeof t && void 0 !== t.nodeType
                ? t
                : "string" == typeof t
    ...
    var k = {
        ...
        M = function (t, e, i) {
            var s = f(e),
                a =
                    -1 === s.getAttribute("class").indexOf("jvm-region")
                        ? "marker"
                        : "region",
                n = "region" === a,
                r = n
                    ? s.getAttribute("data-code")
                    : s.getAttribute("data-index"),
                o = n ? k.onRegionSelected : k.onMarkerSelected;
            return (
                i && (o = n ? k.onRegionTooltipShow : k.onMarkerTooltipShow),
                {
                    type: a,
                    code: r,
                    event: o,
                    ...
                    tooltipText: n
                        ? t._mapData.paths[r].name || ""
                        : t._markers[r].config.name || "",
                }
            );
        };
    var x = (function () {
            ...
            return (
                (t.prototype.dispose = function () {
                    ...
                    for (
                        var t, e = n(Object.getOwnPropertyNames(this));
                        !(t = e()).done;
        ...
        C = (function (e) {
            function i(t) {
                var i,
                    ...
                    h = t.labelStyle,
                    l = t.labelsGroup;
                ((i = e.call(this) || this)._map = s),
                    (i.shape = i._createRegion(n, a, r));
                var c = i.getLabelText(a, o);
                if (o && c) {
                    var u = i.shape.getBBox(),
                        p = i.getLabelOffsets(a, o);
                    (i.labelX = u.x + u.width / 2 + p[0]),
                        (i.labelY = u.y + u.height / 2 + p[1]),
            ...
            var s = i.prototype;
            return (
                (s._createRegion = function (t, e, i) {
                    return (
                        (t = this._map.canvas.createPath(
                            { d: t, dataCode: e },
                            i
    ...
    var L = (function (e) {
        function i(t) {
            var i,
                ...
                u = t.config;
            return (
                ((i = e.call(this) || this).config = u),
                (i.shape = a.canvas.createLine(
                    { x1: r, y1: o, x2: h, y2: l, dataIndex: s },
                    n,
                    c
                )),
        ...
        Y = (function () {
            function t(t, e, i) {
                void 0 === t && (t = {}),
                    ...
                    "object" == typeof t.scale && (this.scale = new X(t.scale)),
                    this.config.legend &&
                        (this.legend = new A(
                            v(
                                { map: this._map, series: this },
                                this.config.legend
                            )
                        )),
                ...
                h =
                    ...
                    Math.log(
                        Math.tan(Math.PI / 4 + r / 2) *
                            (1 / Math.tan(Math.PI / 4 + n / 2))
                    ),
                l =
                    (Math.cos(n) * Math.pow(Math.tan(Math.PI / 4 + n / 2), h)) /
                    h,
    ...
    (E.degRad = 180 / Math.PI),
        (E.radDeg = Math.PI / 180),
        (E.radius = 6381372);
    var T = {
            _setupContainerEvents: function () {
                ...
                this.params.draggable &&
                    (S.on(this.container, "mousemove", function (i) {
                        if (!a) return !1;
                    ...
                    this.params.zoomOnScroll &&
                        S.on(this.container, "wheel", function (t) {
                            var e =
                                    75 *
            ...
            _setupElementEvents: function () {
                ...
                S.on(a, "mousemove", function (s) {
                    Math.abs(t - s.pageX) + Math.abs(e - s.pageY) > 2 &&
                        (i = !0);
                }),
                    ...
                    S.delegate(a, "mouseup", ".jvm-element", function (t) {
                        ...
                        if (
                            !i &&
                            (("region" === e.type &&
                                s.params.regionsSelectable) ||
                                ("marker" === e.type &&
                                    s.params.markersSelectable))
                        ) {
                            var a = e.element;
                            s.params[e.type + "sSelectableOne"] &&
                                s._clearSelected(e.type + "s"),
                                e.element.isSelected
                                    ? a.select(!1)
                                    : a.select(!0),
                                s._emit(e.event, [
                                    e.code,
                    ...
                    S.delegate(a, "click", ".jvm-element", function (t) {
                        var e = M(s, this),
                            ...
                            a = e.code;
                        s._emit(
                            "region" === i ? k.onRegionClick : k.onMarkerClick,
                            [t, a]
                        );
                    });
            },
            ...
            _setupContainerTouchEvents: function () {
                var t,
                    ...
                    h = function (h) {
                        var l,
                            ...
                            p,
                            d = h.touches;
                        if (("touchstart" == h.type && (r = 0), 1 == d.length))
                            1 == r &&
                                ((u = o.transX),
                                (p = o.transY),
                ...
                S.on(o.container, "touchstart", h),
                    S.on(o.container, "touchmove", h);
            },
            _createRegions: function () {
                for (var t in ((this._regionLabelsGroup =
            ...
            _createLines: function (t, e, i) {
                ...
                t)) {
                    ...
                    for (var o in e) {
                        ...
                        h.name === r.from && (s = this.getMarkerPosition(h)),
                            h.name === r.to && (a = this.getMarkerPosition(h));
                    }
                    !1 !== s &&
                        !1 !== a &&
                        (this._lines[_(r.from, r.to)] = new L({
                            index: n,
                            map: this,
                            style: v(
            ...
            _createMarkers: function (t, e) {
                ...
                var s = function () {
                    ...
                    if (e) {
                        if (
                            Object.keys(i._markers).filter(function (t) {
                    ...
                    i._markers[a] && i.removeMarkers([a]),
                        (i._markers[a] = { _uid: r, config: s, element: o });
                };
                for (var a in t) s();
            },
            _createSeries: function () {
                ...
                this.params.series))
                    for (var e = 0; e < this.params.series[t].length; e++)
                        this.series[t][e] = new Y(
                            this.params.series[t][e],
                            "markers" === t ? this._markers : this.regions,
                            this
                        );
            },
            _applyTransform: function () {
                ...
                this._defaultWidth * this.scale <= this._width
                    ...
                    this._defaultHeight * this.scale <= this._height
                        ? ((e =
                              (this._height -
                                  this._defaultHeight * this.scale) /
                              (2 * this.scale)),
                          (s =
                              (this._height -
                                  this._defaultHeight * this.scale) /
            ...
            _resize: function () {
                ...
                this._defaultWidth / this._defaultHeight
                    ? ((this._baseScale = this._height / this._defaultHeight),
                      (this._baseTransX =
                          Math.abs(
                              this._width - this._defaultWidth * this._baseScale
                          ) /
                          (2 * this._baseScale)))
                    : ((this._baseScale = this._width / this._defaultWidth),
                      (this._baseTransY =
                          Math.abs(
                              this._height -
                                  this._defaultHeight * this._baseScale
                          ) /
                          (2 * this._baseScale))),
                    ...
                    void 0 !== e &&
                        ...
                        s
                            ? ((d =
                                  ...
                                  (this._defaultWidth *
                                      (this._width /
                                          (this._defaultWidth * t))) /
                                      2),
                              (f =
                                  i +
                                  (this._defaultHeight *
                                      (this._height /
                                          (this._defaultHeight * t))) /
                                      2))
                            : ((d = this.transX - ((n - 1) / t) * e),
            ...
            coordsToPoint: function (t, e) {
                var i = G.maps[this.params.map].projection,
            ...
            getInsetForPoint: function (t, e) {
                for (
                    var i = G.maps[this.params.map].insets, s = 0;
                    s < i.length;
                    s++
                ) {
                    var a = i[s].bbox,
            ...
            getMarkerPosition: function (t) {
                var e = t.coords;
                return G.maps[this.params.map].projection
            ...
            _repositionLines: function () {
                ...
                for (var i in this._lines) {
                    for (var s in this._markers) {
                        ...
                        a.config.name === this._lines[i].config.from &&
                            (t = this.getMarkerPosition(a.config)),
                            a.config.name === this._lines[i].config.to &&
                                (e = this.getMarkerPosition(a.config));
                    }
                    !1 !== t &&
                        !1 !== e &&
                        this._lines[i].setStyle({
                            x1: t.x,
                            y1: t.y,
                            x2: e.x,
                            y2: e.y,
            ...
            _repositionMarkers: function () {
                for (var t in this._markers) {
                    ...
                    !1 !== e &&
                        this._markers[t].element.setStyle({ cx: e.x, cy: e.y });
                }
            },
                ...
                if (t) {
                    ...
                    if (t.markers)
                        for (var i in this._markers)
                            this._markers[i].element.updateLabelPosition();
                }
            },
        },
        z = (function () {
        ...
        P = (function (e) {
            function i(t, i, s) {
                ...
                return (
                    void 0 === s && (s = {}),
                    ((a = e.call(this, t, i) || this).isHovered = !1),
                    (a.isSelected = !1),
                    (a.style = s),
                    (a.style.current = {}),
                    a.updateStyle(),
            ...
            var s = i.prototype;
            return (
                (s.setStyle = function (t, e) {
                    var i;
                    "object" == typeof t
                        ? v(this.style.current, t)
                        : v(this.style.current, (((i = {})[t] = e), i));
                    this.updateStyle();
                }),
                (s.updateStyle = function () {
                    var t = {};
                    v(t, this.style.initial),
                        v(t, this.style.current),
                        this.isHovered && v(t, this.style.hover),
                        this.isSelected &&
                            (v(t, this.style.selected),
                            this.isHovered && v(t, this.style.selectedHover)),
                        this.set(t);
                }),
                i
            );
        ...
        D = (function (e) {
            ...
            return (
                t(i, e),
                (i.prototype.applyAttr = function (t, i) {
                    "text" === t
                        ? (this.node.textContent = i)
                        : e.prototype.applyAttr.call(this, t, i);
                }),
                i
            );
        })(P),
        ...
        R = (function (e) {
            function i(t) {
                var i;
                return (
                    ((i = e.call(this, "svg") || this)._container = t),
                    (i._defsElement = new z("defs")),
                    (i._rootElement = new z("g", { id: "jvm-regions-group" })),
            ...
            return (
                ...
                (s.createPath = function (t, e) {
                    ...
                    return (
                        i.node.setAttribute("fill-rule", "evenodd"),
                        this._add(i)
                    );
                }),
        ...
        H = (function (e) {
            function s(t) {
                ...
                return (
                    (s._map = t),
                    (s._tooltip = document.body.appendChild(a)),
                    s._bindEventListeners(),
                    i(s) || i(s)
                );
            }
            t(s, e);
                    ...
                    S.on(this._map.container, "mousemove", function (e) {
                        if (t._tooltip.classList.contains("active")) {
                            var i,
                                ...
                                c = e.pageX - o - 5;
                            h && ((l += r + 5), (c -= 10)),
                                e.clientX < a.left + o + 5 &&
                                    ((c = e.pageX + 5 + 2), h && (c += 10)),
                                t.css({ top: l + "px", left: c + "px" });
                        }
                    });
                }),
        ...
        G = (function () {
            ...
            return (
                (e._init = function () {
                    var t = this.params;
                    (this.container = f(t.selector)),
                        this.container.classList.add("jvm-container"),
                        (this.canvas = new R(this.container)),
                        this.setBackgroundColor(t.backgroundColor),
                        this._createRegions(),
                        this.updateSize(),
                        this._createLines(t.lines || {}, t.markers || {}),
                        this._createMarkers(t.markers),
                        this._repositionLabels(),
                        this._setupContainerEvents(),
                        this._setupElementEvents(),
                        t.zoomButtons && this._setupZoomButtons(),
                        t.showTooltip && (this._tooltip = new H(this)),
                        t.selectedRegions &&
                            this._setSelected("regions", t.selectedRegions),
                        t.selectedMarkers &&
                            this._setSelected("_markers", t.selectedMarkers),
                        t.focusOn && this.setFocus(t.focusOn),
                        t.visualizeData &&
                            (this.dataVisualization = new V(
                                t.visualizeData,
                                this
                            )),
                        t.bindTouchEvents &&
                ...
                (e.removeMarkers = function (t) {
                    var e = this;
                    t || (t = Object.keys(this._markers)),
                        t.forEach(function (t) {
                            e._markers[t].element.remove(),
                                delete e._markers[t];
                        });
                }),
                ...
                (e.removeLine = function (t, e) {
                    ...
                    var i = _(t, e);
                    this._lines.hasOwnProperty(i) &&
                        (this._lines[i].element.remove(),
                ...
                (e.reset = function () {
                    ...
                    this.legendHorizontal &&
                        (g(this.legendHorizontal),
                        (this.legendHorizontal = null)),
                        this.legendVertical &&
                            (g(this.legendVertical),
                ...
                (e._emit = function (t, e) {
                    for (var i in k)
                        k[i] === t &&
                            "function" == typeof this.params[i] &&
                            this.params[i].apply(this, e);
                }),
                (e._getSelected = function (t) {
                    var e = [];
                    for (var i in this[t])
                        this[t][i].element.isSelected && e.push(i);
                    return e;
                }),
