                            ...
                            (t.controllers.bar = t.DatasetController.extend({
                                ...
                                draw: function () {
                                    var t = this.chart,
                                        ...
                                        r = 0;
                                    for (
                                        o.canvas.clipArea(t.ctx, t.chartArea);
                                        r < a;
                                        ++r
                                    )
                                        isNaN(e.getRightValue(n.data[r])) ||
                                            i[r].draw();
                        ...
                        legend: {
                            ...
                            onClick: function (t, e) {
                                ...
                                for (
                                    ...
                                    (a = r.getDatasetMeta(i)).data[o].hidden =
                                        !a.data[o].hidden;
                                r.update();
                            },
                        },
                            ...
                            t.controllers.radar = t.DatasetController.extend({
                                ...
                                updateBezierControlPoints: function () {
                                    ...
                                    o.each(e.data, function (i, n) {
                                        var a = i._model,
                                            r = o.splineCurve(
                                                o.previousItem(e.data, n, !0)
                                                    ._model,
                                                a,
                                                o.nextItem(e.data, n, !0)
                                                    ._model,
                                                a.tension
                                            );
                            ...
                            a.extend(t.prototype, {
                                ...
                                buildOrUpdateScales: function () {
                                    var i = this,
                                        ...
                                        o = i.scales || {},
                                        r = [],
                                        s = Object.keys(o).reduce(function (
                                            t,
                                            e
                                        ) {
                                            return (t[e] = !1), t;
                        ...
                        (e.exports = function (t) {
                            ...
                            t.Scale = a.extend({
                                ...
                                beforeUpdate: function () {
                                    o.callback(this.options.beforeUpdate, [
                                        this,
                                    ]);
                                },
                                update: function (t, e, i) {
                                ...
                                afterUpdate: function () {
                                    o.callback(this.options.afterUpdate, [
                                        this,
                                    ]);
                                },
                                ...
                                beforeDataLimits: function () {
                                    o.callback(this.options.beforeDataLimits, [
                                        this,
                                    ]);
                                },
                                determineDataLimits: o.noop,
                                afterDataLimits: function () {
                                    o.callback(this.options.afterDataLimits, [
                                        this,
                                    ]);
                                },
                                beforeBuildTicks: function () {
                                    o.callback(this.options.beforeBuildTicks, [
                                        this,
                                    ]);
                                },
                                buildTicks: o.noop,
                                afterBuildTicks: function () {
                                    o.callback(this.options.afterBuildTicks, [
                                        this,
                                    ]);
                                },
                                ...
                                update: function (e) {
                                    ...
                                    if (I.length) {
                                        ...
                                        C.filter &&
                                            ...
                                            (D.beforeBody = S.getBeforeBody(
                                                z,
                                                P
                                            )),
                                            (D.body = S.getBody(z, P)),
                                            (D.afterBody = S.getAfterBody(
                                                z,
                                                P
                                            )),
                ...
                function (t, e, i) {
                    ...
                    function c(t, e, i, n, a) {
                        ...
                        if (n && a) {
                            ...
                            for (
                                t.lineTo(i[a - 1].x, i[a - 1].y), r = a - 1;
                                r > 0;
                                --r
                            )
                                ...
                                var t = this,
                                    ...
                                    o = (t.ticks = (function (t, e) {
                                        ...
                                        i < 1 &&
                                            ...
                                            (s = Math.round(s * u) / u)),
                                            a.push(
                                                void 0 !== t.min ? t.min : r
                                            );
                                        for (var d = 1; d < l; ++d)
                                            a.push(
                                                Math.round((r + d * i) * u) / u
                                            );
                                        return (
                                            a.push(
        ...
        : ((t.prototype.beforeDatasetsUpdate = function (t) {
          ...
          (t.prototype.parseOptions = function (t) {
              ...
              return (
                  ...
                  (this.fontColor =
                      e.fontColor || this.options.defaultFontColor),
                  (this.fontStyle =
                      e.fontStyle || this.options.defaultFontStyle),
                  (this.fontFamily =
                      e.fontFamily || this.options.defaultFontFamily),
                  (this.hasTooltip =
                      t.tooltip._active && t.tooltip._active.length),
          ...
          (t.prototype.loadImage = function (t) {
              var e = new Image();
              return (
                  (e.src = t.src), (e.width = t.width), (e.height = t.height), e
              );
          }),
          (t.prototype.drawArcText = function (t, e, i, o) {
              ...
              if (
                  ((n +=
                      ((i += Math.PI / 2) -
                          ((s = this.measureText(t)).width / e + n)) /
                      2),
                  o || !(i - n > r))
              )
                  if ("string" == typeof t)
