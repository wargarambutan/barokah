...
async function generateIdCard() {
  ...
  const backgroundImageUrl = "bgkr.png";
  ...
  background.onload = async function () {
    ...
    const profileUri = await getDataUrl("kosong.jpg", 400, 400);
    ...
    doc.text("HOLILURRAHMAN", 1.06525, 1.92, null, null, "center");
    doc.setFont("Poppins", "medium");
    doc.setFontSize(8);
    doc.setTextColor(SECONDARY_COLOR);
    doc.text("Developer", 1.06525, 2.025, null, null, "center");
    ...
    doc.text("KRY15529863", 1.3, 2.3, null, null, "center");
    doc.text("No. Telp", 0.745, 2.4, null, null, "center");
    doc.text(":", 0.958, 2.4, null, null, "center");
    doc.text("087771165435", 1.3, 2.4, null, null, "center");

    doc.setFillColor("#000");
    // doc.rect(0.833, 2.68, 0.5, 0.5, "F");
    const qrCodeUri = getQrCodeUri("KRY15529863");
